...
* **Status (May 2026):**
  ...
  * Phase 9H scaffold (started): branch `feat/phase9h-core-decl-groups` and implementation scaffold doc `docs/phase9h-core-decl-groups.md` created to execute the two remaining Phase 10 prerequisites.
