...
* **Tasks:**
  ...
  * [ ] Implement `let` → stack local, `case` → `switch`/`if-else` chain. (`let` CPVar path landed; case lowering remains placeholder)
