...
* **Tasks:**
  ...
  * [ ] Move large static runtime C prelude/helper text from inline literals in CGen to a compile-time embedded template resource (executable-embedded; no runtime path lookup).
